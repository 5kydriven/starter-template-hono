...
export const AuthUserSchema = z.object({
	...
	createdAt: z.iso.datetime().openapi({ example: '2026-06-17T00:00:00.000Z' }),
	updatedAt: z.iso.datetime().openapi({ example: '2026-06-17T00:00:00.000Z' }),
});
...
export const AuthSessionSchema = z.object({
	...
	expiresAt: z.iso.datetime().openapi({ example: '2026-06-24T00:00:00.000Z' }),
