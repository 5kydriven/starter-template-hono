...
export const AuthUserSchema = z
	.object({
		...
		createdAt: z.string().datetime().openapi({ example: '2026-06-17T00:00:00.000Z' }),
		updatedAt: z.string().datetime().openapi({ example: '2026-06-17T00:00:00.000Z' }),
	})
	.openapi('AuthUser');
...
export const AuthSessionSchema = z
	.object({
		...
		expiresAt: z.string().datetime().openapi({ example: '2026-06-24T00:00:00.000Z' }),
